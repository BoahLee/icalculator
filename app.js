...
const handleDelete = del => {
    calculator.displayValue = calculator.displayValue.length === 1 ? "0" : calculator.displayValue.substr(0, calculator.displayValue.length - 1)
};
...
const handleOperator = nextOperator => {
    ...
    if (firstOperand === null) {
        ...
        const result = performCalculation(currentValue, operator, displayValueFloat);
